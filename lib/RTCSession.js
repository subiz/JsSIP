...
module.exports = class RTCSession extends EventEmitter
{
  ...
  answer(options = {})
  {
    ...
    Promise.resolve()
      ...
      .then(() =>
      {
        ...
        const offer = new window.RTCSessionDescription({ type: 'offer', sdp: e.sdp });
      ...
      switch (request.method)
      {
        case JsSIP_C.ACK:
          ...
          if (this._late_sdp)
          {
            ...
            const answer = new window.RTCSessionDescription({ type: 'answer', sdp: e.sdp });
  ...
  {
    this._connection = new window.RTCPeerConnection(pcConfig, rtcConstraints);
